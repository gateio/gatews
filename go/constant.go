...
var authChannel = map[string]bool{
	...
	// ChannelSpotOrderAmend:     true,
	// ChannelSpotOrderCancel:    true,
	// ChannelSpotOrderCancelCp:  true,
	// ChannelSpotOrderCancelIds: true,
	// ChannelSpotOrderPlace:     true,
	// ChannelSpotOrderStatus:    true,
	...
	// ChannelFutureOrderAmend:       true,
	// ChannelFutureOrderCancel:      true,
	// ChannelFutureOrderCancelCp:    true,
	// ChannelFutureOrderPlace:       true,
	// ChannelFutureOrderBatchPlace:  true,
	// ChannelFutureOrderStatus:      true,
	// ChannelFutureOrderList:        true,
}
